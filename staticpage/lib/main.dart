...
we have a professional Designers
  ...
  Nedivile technologies is the best one-step solution for your business upliftment, providing you with the best quality web design and web development with creative designers. 
  Our web design packages are highly cost efficient. We provide you with the premium web designing services and 10% discounts for the first project that you do with us.

  All of our websites are designed to be fully secure and responsive – automatically resizing for device screen size –
  so whether your website is being viewed on a desktop, PC or mobile phone, it will look amazing.
    ''',
    '''  
...
App development
    The nediveil  team handles the full cycle of mobile app design and development services. 
    We produce only top-notch applications with great design UX, UI, navigation, & functionality.
    ''',
    "",
  ];
  List<Color> colours = [
